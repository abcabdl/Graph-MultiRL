...
from graphcredit_offline.core.rollout_logger import annotate_rollout_item
        ...
        for bs in range(batch_size):
            ...
            for data in total_batch_list[bs]:
                ...
                if data['active_masks']:
                    ...
                    annotate_rollout_item(
                        data,
                        local_index=len(effective_batch),
                        orchestra_type=getattr(self.config.agent, "orchestra_type", None),
                    )
        ...
        for _step in range(self.config.env.max_steps):
            ...
            for data in multiagent_batch_buffer:
                ...
                if text_responses is not None:
                    agent_batch.non_tensor_batch['graphcredit_output'] = np.array(text_responses, dtype=object)
